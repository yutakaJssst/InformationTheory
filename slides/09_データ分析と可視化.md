...
<div class="prompt-box">
2群のデータに有意差があるか検定するPythonコードを書いてください。<br>
- まず正規性の確認（Shapiro-Wilk検定）<br>
- 正規分布の場合: t検定<br>
- 非正規分布の場合: Mann-Whitney U検定<br>
- 有意水準は0.05<br>
- 効果量（Cohen's d）も計算<br>
- 結果を分かりやすく表示<br><br>
scipyを使用してください。
</div>
...
<div class="prompt-box">
以下のデータを使って、論文に掲載できる品質の棒グラフをmatplotlibで作成してください。<br><br>
要件:<br>
- 白黒印刷でも識別できるようにハッチングを使用<br>
- フォントサイズ: タイトル14pt、軸ラベル12pt、目盛り10pt<br>
- 図のサイズ: 幅8cm x 高さ6cm（論文の1カラム幅）<br>
- 解像度: 300dpi<br>
- エラーバー付き<br>
- PDF形式で保存
</div>
...
- <span class="teal">**軸ラベル**</span>（単位を含む）
- <span class="teal">**凡例**</span>（位置は適切か）
- <span class="teal">**フォントサイズ**</span>（印刷時に読めるサイズ）
- <span class="teal">**解像度**</span>（300dpi以上）
...
- <span class="teal">**適切なアスペクト比**</span>
...
3. AIの解釈を読む
4. <span class="highlight">自分の言葉で修正</span>する

### 重要
- AIの解釈は<span class="orange">**あくまで参考**</span>
- 研究の文脈を踏まえた解釈は<span class="highlight">自分で行う</span>
- 論文では自分の言葉で結果を記述する
- 統計的有意差と実質的な意味の違いに注意
...
### 提出物
1. <span class="teal">**データ分析レポート**</span>
   - 使用データの説明 / 分析手法と結果 / 考察（自分の言葉で）
2. <span class="teal">**論文品質のグラフ3つ**</span>
   - 棒グラフ、散布図、箱ひげ図（または研究に適したグラフ）
   - 白黒対応、300dpi以上
3. **使用したプロンプトの記録**
