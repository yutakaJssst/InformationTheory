...
| 2. 修正サイクル | 1/15〜21 | AIの統計ミスを人間が修正 | 15 |
| 3. 論文執筆 | 3/7〜14 | 英語論文の執筆・推敲 | 20 |

---

## <span class="red">AIが間違えた統計処理</span>

| AIの誤り | 人間による修正 |
|---------|------------|
| 効果量 $r$ の計算で全標本数 $n$ を使用 | $n_{\text{nonzero}}$（ゼロ差分除外）を使用 |
...
### 第10回: AIを用いたデータ分析（6/24）

- Titanicデータを例題に、前処理・可視化・分類モデル評価の流れを確認する
- AIが出したコードや説明を、実行結果・数値・グラフと照合する
- Bank Marketingデータと、自分で探す公開データへ分析の型を広げる

### 準備
- Google Colabを使える状態にしておく
- Classroomから配布されるデータとノートブックを確認する
