...
<span class="teal">研究の核心を1-2文に絞ることがAIへの指示の出発点</span>
...
- AIが生成した説明の <span class="red">**正確性を必ず確認**</span>（分野固有の定義と異なる場合あり）
...
- [mermaid.live](https://mermaid.live) でプレビュー可能
...
3. <span class="teal">**カスタマイズ**</span>: 色、フォント、レイアウトを調整
...
2. **AIツール** を使って、学会発表用スライドの構成案を生成する
