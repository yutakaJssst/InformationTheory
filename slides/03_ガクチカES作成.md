...
> 企業は「何をしたか」より「**どう考え、どう動いたか**」を見ている
...
2. **AIとの対話ログ**
   - Gemini Proとのやり取りのスクリーンショットまたはコピー
   - どのステップでどう活用したかが分かるように

### 提出方法
- 次回授業（5/13）までに指定の方法で提出
...
### 情報論 2025-4: AI活用(2) 文献調査
**5月13日（対面）**

- 研究調査におけるAIツールの活用
- Gemini Pro / Perplexity / NotebookLM の使い分け
- プロンプトエンジニアリングの実践
- 演習: 自分の研究テーマで文献調査
