...
### なぜ <span class="teal">Gemini Pro</span> を推奨するか？
...
| ツール | 料金 | 特徴・メリット |
|--------|------|----------------|
| **ChatGPT Plus** | $20/月 | GPT-4o, Code Interpreter, DALL-E 画像生成、Advanced Data Analysis |
| **Claude Pro** | $20/月 | 長文処理に優れる、高度な推論、Artifacts機能 |
| **GitHub Copilot** | **学生無料** | コード補完、IDE統合、プログラミング効率が劇的に向上 |
| **Gemini Advanced** | Google One AI Premium | Gemini Ultra、1MBトークン、Google Workspace連携 |
...
> **迷ったらまず <span class="teal">Gemini Pro</span> を試してみよう！**
...
1. **3つ以上のAIツール**を実際に使ってみる
   - Gemini Pro（必須）＋ 2つ以上のツールを自由に選択

2. **同じ質問**を各ツールに投げて、回答を比較する
   - 質問例: 「自分の研究テーマについて300字で説明してください」
   - 質問例: 「〇〇分野の最新の研究動向を教えてください」

3. **比較レポート**を作成する（A4で2〜3枚）
   - 各ツールの回答の質（正確性・網羅性・読みやすさ）
   - 各ツールの使い勝手（操作性・速度・UIの良さ）
...
**日時**: 2025年4月22日（火）対面授業

### 内容

- <span class="highlight">プロンプトの書き方</span>で AIの回答が劇的に変わる
