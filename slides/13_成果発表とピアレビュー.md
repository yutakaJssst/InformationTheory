...
| 回 | テーマ | 身につけたスキル |
|----|--------|-----------------|
| OD-1 | AI総覧・ガイダンス | 主要ツールの全体像と選定基準 |
| 2 | プロンプトエンジニアリング | ROCFモデル・段階的指示 |
| 3 | ガクチカ・ES作成 | STAR法＋AIによる推敲 |
| 4 | 文献調査 | AIを使った論文検索・要約 |
| 5-6 | 英語論文作成(1)(2) | 4原則・段階的推敲・相互レビュー |
...
| 回 | テーマ | 身につけたスキル |
|----|--------|-----------------|
| 7 | 研究発表スライド | AIによるスライド構成・デザイン |
| 8 | GitHub・Webページ | Git操作、GitHub Pages公開 |
| 9 | データ分析と可視化 | Python・統計検定・グラフ作成 |
| 10 | 新規性分析・ポートフォリオ | 3観点での研究の言語化 |
| 11-12 | ソフトウェア開発(1)(2) | コード生成・テスト・品質管理 |
