...
| 1 | タイトル・自己紹介 | - |
| 2 | **自分の研究テーマの紹介** | 30秒 |
| 3 | **この授業でAIを活用して作成した成果物の紹介** | 1分 |
| 4 | **特に効果的だったAI活用法** / **AI活用で感じた限界・課題** | 1分 |
| 5 | まとめ・今後の展望 | 30秒 |

### ポイント

- 具体的な成果物（スライド、Webページ、ポートフォリオ等）を <span class="teal">**見せながら**</span> 説明
...
| | <span class="green">効果</span> | <span class="red">限界</span> |
|---|---|---|
| 1 | <span class="teal">**作業効率の向上**</span> — 初稿作成の時間を大幅短縮 | <span class="red">**ハルシネーション**</span> — もっともらしい嘘を生成する |
| 2 | <span class="teal">**アイデアの拡張**</span> — 自分では思いつかない視点の提供 | <span class="red">**創造性の限界**</span> — 真に革新的なアイデアは生まれにくい |
| 3 | <span class="teal">**英語表現の改善**</span> — ネイティブレベルの表現を学べる | <span class="red">**専門知識の必要性**</span> — 出力の正否を判断するには専門知識が不可欠 |
| 4 | <span class="teal">**コード品質の向上**</span> — バグの発見、リファクタリング | <span class="red">**倫理的課題**</span> — 著作権、プライバシー、公平性 |
...
- **締切: <span class="red">7/22（火）23:59</span>**
