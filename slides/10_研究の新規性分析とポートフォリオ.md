...
# 研究の新規性分析とポートフォリオ
## 情報論 2025 第10回 ― AI活用(8)

担当: 松野 裕｜日本大学大学院理工学研究科
2025年6月24日（対面授業・100分）
...
「私の研究テーマは <strong>[テーマ]</strong> です。この研究に関連する研究分野を整理し、私の研究がどこに位置づけられるかマッピングしてください。<br>
- 関連する上位分野と下位分野<br>
- 隣接する研究領域<br>
- 私の研究が埋めるギャップ<br><br>
図示できるように、箇条書きの階層構造でお願いします」
</div>
...
<div class="prompt-box">
「以下の先行研究と比較して、私の研究の独自性を分析してください。<br>
- 先行研究A: [タイトル・概要]<br>
- 先行研究B: [タイトル・概要]<br>
- 先行研究C: [タイトル・概要]<br>
- 私の研究: [概要]<br><br>
<strong>3つの観点</strong>（方法論、適用領域、評価方法）から差分を分析し、表形式でまとめてください」
</div>
...
<div class="prompt-box">
「以下の分析結果を元に、研究の新規性を学会発表のIntroductionで使える <strong>3文</strong> にまとめてください。<br>
- 位置づけ: [Step 1の結果]<br>
- 差分: [Step 2の結果]<br><br>
以下の形式でお願いします:<br>
1文目: 既存研究の課題を指摘<br>
...
| 観点 | 内容 |
|------|------|
| <span class="teal">**方法論的新規性**</span> | GSN（Goal Structuring Notation）と安全状態レポートを統合した新しいアシュアランスケース手法 |
| <span class="teal">**実践的新規性**</span> | L4自動運転（特定条件下での完全自動運転）への適用 |
| <span class="teal">**定量的評価**</span> | コンセンサススコアによる安全性評価の客観化 |

### 新規性を3文で表現
1. 従来の安全性保証手法は、自動運転のような動的システムへの適用が困難であった
2. 本研究では、GSNと安全状態レポートを統合し、運用時の安全性を継続的に評価するフレームワークを提案する
3. L4自動運転への適用実験により、コンセンサススコアを用いた定量的な安全性評価が可能であることを示した
...
1. <span class="teal">**Step 1**</span>（5分）: Gemini Proで研究の位置づけマッピングを作成
...
### 成果物
- 新規性を表現する <span class="highlight">3文</span> を完成させる
...
<div class="prompt-box">
「大学院生の研究ポートフォリオ用のREADME.mdをMarkdown形式で作成してください。以下の情報を含めてください:<br>
- 名前: [名前]<br>
- 所属: 日本大学大学院理工学研究科<br>
- 研究テーマ: [テーマ]<br>
- 主要成果: [成果リスト]<br><br>
セクション構成: About Me, Research, Publications, Skills, Contact<br>
GitHubのREADMEとして見やすいフォーマットにしてください」
</div>
...
### 評価ポイント
- <span class="teal">**研究の明確さ**</span>
- <span class="teal">**AI活用の工夫**</span>
- <span class="teal">**発表のわかりやすさ**</span>
- <span class="teal">**ポートフォリオの完成度**</span>
