...
- **授業形式**: 100分 × 13回 ＋ オンデマンド（本回・50分）／ **対象**: 大学院理工学研究科の学生
...
- 学生の理解度に合わせた課題の難易度調整／採点ルーブリック・模範解答の作成支援
...
| 2024年12月 | **Gemini 2.0** → マルチモーダル・エージェント機能 |
| 2025年1月 | **DeepSeek R1** → オープンソース推論モデルが世界的注目 |
| 2025年5〜8月 | **Claude 4** ／ **Gemini 2.5** ／ **GPT-5** が相次いでリリース |
| 2025年9〜12月 | **Claude Opus 4.5** ／ **GPT-5.2** ／ **Gemini 3 Flash** |
| 2026年2〜3月 | **Claude 4.6** ／ **GPT-5.4** — 1Mトークン・エージェント機能が標準に |
