...
| <span class="orange">**中**</span> | 未発表だが自分の研究データ | **オプトアウト設定後**に利用可。学習除外確認が前提 |
| <span class="green">**低**</span> | 公開済論文・公開可能なメモ | 通常利用OK |

</span>

> 「絶対入れない」より「<span class="highlight">契約と設定を確認した上で判断する</span>」が実務的
...
| ツール | デフォルト | オプトアウト方法 |
|--------|-----------|----------------|
| **ChatGPT 無料/Plus** | 学習対象 | Settings → Data Controls → "Improve the model" OFF |
| **ChatGPT Team/Enterprise/API** | <span class="green">学習対象外</span> | デフォルトで保護 |
| **Claude (Anthropic)** | <span class="green">学習対象外</span> | デフォルトで保護 (公式明言) |
| **Gemini 個人 Google アカウント** | 学習対象 | アクティビティ設定で OFF |
| **Gemini for Workspace** (大学発行 .ac.jp) | <span class="green">学習対象外</span> | エンタープライズ保護 |
| **Google AI Studio 無料** | 学習対象 | API経由なら未学習 |
| **ローカルLLM** (Ollama等) | <span class="green">送信なし</span> | ネットワーク隔離 |

</span>

> **オプトアウトしても**ベンダーサーバには送信される。大学発行アカウントを優先的に使うのが最も安全
