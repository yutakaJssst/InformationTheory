...
### 情報爆発
- arXivだけで<span class="highlight">年間20万件超</span>（2024年は約24万件）の論文が投稿される
...
1. AIでキーワード候補を<span class="teal">**広げる**</span>
2. AI検索で<span class="teal">**見落としを減らす**</span>
3. AIで論文を<span class="teal">**要約・比較**</span>
4. AIで関連研究の<span class="teal">**候補を提示**</span>させる
5. AIで<span class="teal">**構造的**</span>に整理
6. AIで新規性の<span class="teal">**たたき台**</span>を作る
...
## <span class="red">機密情報の取り扱い: リスク3段階で判断</span>

<span class="small">

| リスク | 該当データ | 推奨対応 |
|--------|-----------|---------|
| <span class="red">**高**</span> | 特許出願前のアイデア／NDA対象データ | <span class="red">**どのAIにも入れない**</span>。公知化・契約違反リスク |
| <span class="orange">**中**</span> | 未発表だが自分の研究データ | <span class="red">**そのままは入力しない**</span>。匿名化・要約済み・公開して問題ない範囲に限定 |
| <span class="green">**低**</span> | 公開済論文・公開可能なメモ | 通常利用OK |

</span>

> 「絶対入れない」より「<span class="highlight">契約と設定を確認した上で判断する</span>」が実務的。NDA/特許出願前/共同研究データは原則入力しない
...
| **ChatGPT Business/Enterprise/API** | <span class="green">利用しない</span> | 契約上保護 |
| **Claude (Anthropic)** | <span class="green">原則利用しない</span> | ユーザー許可・安全性レビュー対象は例外 |
| **Gemini 個人 Google アカウント** | デフォルトで利用 | アクティビティ設定で OFF |
| **Gemini API 無料枠 (AI Studio含む)** | <span class="orange">利用される</span> | 入出力が改善目的に使われ、人間レビュアーが確認する場合あり |
| **Gemini API 有料枠 (Cloud Billing有効)** | <span class="green">利用しない</span> | 規約上保護 |
| **Gemini for Workspace (Education/Enterprise契約)** | <span class="green">利用しない</span> | 管理者設定の対象、契約に紐づく |
| **ローカルLLM** (Ollama等) | <span class="green">送信なし</span> | ネットワーク隔離 |
...
| **O** - Objective | 目的 | 「関連研究の候補を広く調べたい」 |
| **C** - Context | 文脈 | 「私の研究テーマは○○です」 |
| **F** - Format | 出力形式 | 「表形式で比較してください」 |

### 文献調査で効くポイント
- <span class="teal">**Role**</span>に分野名を入れる → 一般論ではなく分野固有の語彙で返ってくる
- <span class="teal">**Context**</span>を厚くするほど推測の余地が減る。ただし論文名・著者名・数値は<span class="red">必ず確認する</span>
...
**目的**: 検索の漏れを減らすため、関連キーワードの候補を広く洗い出す
...
<div class="prompt-box">
Find seminal papers and recent survey papers on [keywords].<br><br>
For each paper, provide:<br>
- Title, authors, and year<br>
- Brief summary and main contribution<br>
- Citation count if available<br><br>
Include both foundational works and papers from the last 5 years.
</div>

### なぜ英語で検索するのか
- 学術論文の大半は英語で書かれている
- 英語キーワード・英語タイトルで検索すると、英語圏の学術文献に当たりやすい
...
- AIは<span class="red">**もっともらしい誤情報**</span>を出力することがある（ハルシネーション）
- 特に「論文の捏造」は要注意
