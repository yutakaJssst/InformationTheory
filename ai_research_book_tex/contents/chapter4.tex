...
しかし、英語を母語としない研究者にとって、学術英語の壁は非常に高い。従来は英文校正サービスやネイティブの共同研究者に頼ることが一般的であったが、AIの登場により、英語論文執筆のハードルは大きく下がった。AIは万能ではないが、適切に活用すれば、執筆の効率と品質を大幅に向上させることができる。
...
冠詞（a, an, the, 無冠詞）は、日本語話者にとって最も難しい文法事項の一つである。
...
日本語の学術文では受動態が多用されるが、英語論文では能動態も積極的に使う。過度な受動態は文章を読みにくくする。
