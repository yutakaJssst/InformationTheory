...
GitHubアカウントを作成し、GitHub Educationに登録しなさい。\texttt{my\allowbreak-first\allowbreak-repo}という名前のリポジトリを作成し、GitHub Desktopでクローンした後、テキストファイルを1つ追加してコミット・プッシュしなさい。スクリーンショットを撮影して提出すること。
